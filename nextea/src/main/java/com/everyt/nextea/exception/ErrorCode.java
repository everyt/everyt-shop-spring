...
public enum ErrorCode {
    ...
    ALREADY_EXIST_USER(HttpStatus.BAD_REQUEST, "이미 가입되어 있는 이메일입니다"),
    ...
    /* 405 METHOD_NOT_ALLOWED : 메소드에 접근할 수 없습니다 */
    DUPLICATE_PERSISTENCE(HttpStatus.METHOD_NOT_ALLOWED, "엔티티 영속성이 잘못 설정되었습니다"),
